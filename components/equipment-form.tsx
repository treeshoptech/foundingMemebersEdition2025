          ...
          <Card className="border-2 border-blue-500 dark:border-blue-400">
            <CardHeader className="bg-blue-50 dark:bg-blue-950">
              ...
              <CardDescription className="text-xs mt-1">
                This is the raw equipment cost. Billing rates are set at the Loadout level when combining equipment + employees.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-6 space-y-3">
              ...
              <div className="flex justify-between text-lg font-bold bg-blue-50 dark:bg-blue-950 p-3 rounded-lg">
              ...
              <p className="text-xs text-muted-foreground text-center pt-2">
                💡 Add this equipment to a Loadout to set billing rates and profit margins
              </p>
            </CardContent>
          </Card>
